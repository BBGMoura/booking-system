...
public class UniversalExceptionHandler {
  ...
  public ResponseEntity<ErrorModel> handleHttpMessageNotReadable(
  ...
  public ResponseEntity<ErrorModel> handleLockTimeoutException(LockTimeoutException ex) {
    LOG.warn("Advisory lock timeout: {}", ex.getMessage());
    ErrorModel error =
        new ErrorModel(
            new Date(),
  ...
  public ResponseEntity<ErrorModel> handleOptimisticLockingFailure(
  ...
  private static String getFormatErrorMessage(Throwable cause) {
    if (cause instanceof InvalidFormatException ifEx && ifEx.getTargetType().isEnum()) {
      return String.format(
          ...
          ifEx.getValue(), Arrays.toString(ifEx.getTargetType().getEnumConstants()));
    }
