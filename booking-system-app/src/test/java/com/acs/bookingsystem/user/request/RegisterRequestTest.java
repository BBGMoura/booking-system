...
class RegisterRequestTest {
  ...
  void validRegisterRequest() {
    RegisterRequest request =
        new RegisterRequest("John", "Doe", "john.doe@example.com", "07112233445", "Password1!");
  ...
  void firstNameBlank(String firstName) {
    RegisterRequest request =
        new RegisterRequest(firstName, "Doe", "john.doe@example.com", "07112233445", "Password1!");
  ...
  void firstNameTooLong() {
    RegisterRequest request =
        new RegisterRequest(
            "J".repeat(51), "Doe", "john.doe@example.com", "07112233445", "Password1!");
  ...
  void lastNameBlank(String lastName) {
    RegisterRequest request =
        new RegisterRequest("John", lastName, "john.doe@example.com", "07112233445", "Password1!");

    Set<ConstraintViolation<RegisterRequest>> violations = validator.validate(request);
    assertFalse(violations.isEmpty());
    assertTrue(
        violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("lastName")));
  }
  ...
  void lastNameTooLong() {
    RegisterRequest request =
        new RegisterRequest(
            "John", "D".repeat(51), "john.doe@example.com", "07112233445", "Password1!");
  ...
  void emailInvalid(String email) {
    RegisterRequest request =
        new RegisterRequest("John", "Doe", email, "07112233445", "Password1!");
  ...
  void phoneNumberInvalid(String phoneNumber) {
    RegisterRequest request =
        new RegisterRequest("John", "Doe", "john.doe@example.com", phoneNumber, "Password1!");
  ...
  void phoneNumberValid(String phoneNumber) {
    ...
    assertTrue(
        violations.isEmpty()
            || violations.stream()
                .noneMatch(v -> v.getPropertyPath().toString().equals("phoneNumber")));
  }
  ...
  void passwordInvalid(String password) {
    RegisterRequest request =
        new RegisterRequest("John", "Doe", "john.doe@example.com", "07112233445", password);
