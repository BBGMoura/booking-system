...
class UpdateUserRequestTest {
  ...
  void validUpdateRequest() {
    UpdateUserRequest request = new UpdateUserRequest("john.doe@example.com", "Password1!");
  ...
  void emailInvalid(String email) {
    UpdateUserRequest request = new UpdateUserRequest(email, "Password1!");
  ...
  void passwordInvalid(String password) {
    UpdateUserRequest request = new UpdateUserRequest("john.doe@example.com", password);
