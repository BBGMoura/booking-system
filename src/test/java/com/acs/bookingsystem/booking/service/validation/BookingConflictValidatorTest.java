...
class BookingConflictValidatorTest {

    @Mock
    private BookingRepository bookingRepository;

    private BookingConflictValidator validator;
    ...
    @BeforeEach
    void setup() {
        validator = new BookingConflictValidator(bookingRepository);
    }

    @Test
    void givenNoConflictingBookings_shouldReturnEmpty() {
        when(bookingRepository.findActiveBookingsForRoomAndTimeRange(eq(Room.ASTAIRE), eq(false), any(), any()))
                .thenReturn(List.of());
